...
/**
 * The class RoadSegment stores the information of a road (edge between intersections).
 * The class holds information about roads such as length of a road, density of a road, and the number of lanes
